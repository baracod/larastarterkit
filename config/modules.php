...
return [
    ...
    */
    'stubs' => [
        'enabled' => true,
        'path' => base_path('stubs/larastarterkit/laravel-module'),
        'files' => [
        ...
        'replacements' => [
            ...
            'moduleIndex.vue' => ['LOWER_NAME'],
            'menuItems.json' => ['LOWER_NAME'],
            'composer' => [
                'LOWER_NAME',
                'STUDLY_NAME',
                'VENDOR',
    ...
    'paths' => [
        ...
        */
        'generator' => [
            ...
            'ts' => ['path' => 'resources/ts', 'generate' => true],
            'pages' => ['path' => 'resources/ts/pages', 'generate' => true],
            // 'pages-index' => ['path' => 'resources/ts/pages/index.vue', 'generate' => true],
            'components' => ['path' => 'resources/ts/components', 'generate' => true],
            'stores' => ['path' => 'resources/ts/stores', 'generate' => true],
            'routes' => ['path' => 'resources/ts/routes', 'generate' => true],
            'types' => ['path' => 'resources/ts/types', 'generate' => true],
            // 'menuItems' => ['path' => 'menuItems.ts', 'generate' => true],
    ...
    */
    'composer' => [
        ...
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Nicolas nwidart'),
